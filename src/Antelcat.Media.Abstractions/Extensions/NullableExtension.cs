...
public static class NullableExtension
{
    ...
    public static T NotNull<T>(this T? t) where T : notnull => 
    ...
    /// <returns></returns>
    /// <exception cref="NullReferenceException"></exception>
    public static T NotNull<T, TException>(this T? t) where T : notnull where TException : Exception, new() => 
    ...
    /// <returns></returns>
    /// <exception cref="NullReferenceException"></exception>
    public static T NotNull<T>(this object? t) where T : notnull => 
